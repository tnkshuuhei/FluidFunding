...
let config = {
    ...
    url: 'https://corsproxy.io/?https://s233z7wptngdtmmcgkxqchn2eu.multibaas.com/api/v0/events?contract_label=grant&contract_address=grant2&event_signature=RegisteredProject(address,string,string,address)',
    headers: {
